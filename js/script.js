// Importando as funções de validação de senha
...
formulario.addEventListener("submit", async (e) => {
    ...
    if (formularioValido) {
        try {
            ...
            exibirMensagem("flex","green","Conta Criada Com Sucesso!");
...
// Adicionando eventos de blur e invalid ao campos do formulário
camposDoFormulario.forEach((campo) => {
